    ...
    while True:
        try:
            ...
            with open(".\\test\\test-spam-{:05d}.txt".format(i)) as test_file:
                ...
                score_spam = score_spam + math.log10(prior_spam)
                if score_spam > score_ham:
                    print(line_counter,"test-spam-{:05d}.txt".format(i),"spam",score_ham,score_spam,"spam","right")
                    right_count += 1
                else:
                    print(line_counter, "test-spam-{:05d}.txt".format(i), "ham", score_ham, score_spam, "spam", "wrong")
                    wrong_count += 1
                line_counter += 1
        except FileNotFoundError:
